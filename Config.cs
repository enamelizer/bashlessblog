...
namespace bashlessblog
{
    internal class Config
    {
        ...
        public string DateFormat { get; private set; } = "%B %d, %Y";
        public string DateLocale { get; private set; } = "C";
        public string DateInpost { get; private set; } = "bashblog_timestamp";
        // Don't change these dates
        public string DateFormatFull { get; private set; } = "%a, %d %b %Y %H:%M:%S %z";
        public string DateFormatTimestamp { get; private set; } = "%Y%m%d%H%M.%S";
        public string DateAllpostsHeader { get; private set; } = "%B %Y";
